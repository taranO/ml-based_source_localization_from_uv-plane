...
from src.trainer.sampled_inverse_re_im import SampledInverseReIm
...
# --- pretrained stage 1 model params ----
parser.add_argument('--pre_pref', default="noisy_re_im_st1_seed_%d")
parser.add_argument('--pre_epoch', default=1000, type=int, help='number of total epochs to run')

# training parameters
parser.add_argument('--epochs', default=1000, type=int, help='number of total epochs to run')
parser.add_argument('--start_epoch', default=1, type=int)
parser.add_argument('--pref', default="noisy_re_im_st2_seed_%d")
...
class PostTrainingRun(BaseRun):
    def __init__(self, args, config):
        ...
        self.sampled_inverse = SampledInverseReIm(config=self.config, args=self.args)
